    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(help_text='Укажите время приготовления блюда', validators=[django.core.validators.MinValueValidator(1)], verbose_name='Время приготовления (в минутах)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(help_text='Введите цветовой код в 16-ричном формате', max_length=7, verbose_name='Цветовой hex-код')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recipe', models.ForeignKey(help_text='Выберите рецепт, который хотите добавить в список', on_delete=django.db.models.deletion.CASCADE, related_name='shoppingcart', to='recipes.recipe', verbose_name='Рецепт')),
